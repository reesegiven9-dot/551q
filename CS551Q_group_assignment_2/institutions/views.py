...
from .models import Institution, PerformanceRecord, Region
...
def login_view(request):
    ...
    return render(request, "institutions/auth/login.html", {"form": form})
...
def register_view(request):
    ...
    return render(request, "institutions/auth/register.html", {"form": form})
